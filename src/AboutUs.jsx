...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Dong Bong's Nursery, where greens meet weens!</p>
      <p className="about-us-content">
        At Dong Bong's Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Dong Bong's Nursery today and experience the 
